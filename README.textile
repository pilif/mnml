...
* Small - the framework is around 400 lines of code, and a lot of those are comments.
* Fast - 
* WSGI - so you can make use of a range of available WSGI middleware.
* Tested - at least a bit. The module includes a test runner and a growing suite of tests.
